    ...
    return (
        <>
            <div className="product1">
                <h1>DYMATIZE NUTRITION ELITE WHEY PROTEIN POWDER - 5 LBS (RICH CHOCOLATE)</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        <div className="small-imgs">
                            <img src="Img/product 39.jpg"></img>
                            <img src="Img/product 39.jpg"></img>
                            <img src="Img/product 39.jpg"></img>
                            <img src="Img/product 39.jpg"></img>
                            <img src="Img/product 39.jpg"></img>
                        </div>
                        <img src="Img/product 39.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>DYMATIZE NUTRITION ELITE WHEY PROTEIN POWDER - 5 LBS (RICH CHOCOLATE)</h2>                                
            ...
            <div className="container description">
                ...
                <h4>Description</h4>
                <p>
                    Brand	Dymatize Nutrition <br></br>
                    Flavour	Rich Chocolate <br></br>
                    Item Weight	5 Pounds <br></br>
                    ...
                    29 grams of protein per serving, 3.5 grams of glutamine and glutamine precursors, 5 grams of BCAAs, low in carbs and aspartame free <br></br>
