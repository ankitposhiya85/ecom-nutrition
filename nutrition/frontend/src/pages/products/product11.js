    ...
    return (
        <>
                ...
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        <div className="small-imgs">
                            <img src="Img/product 40.jpg"></img>
                            <img src="Img/product 40.jpg"></img>
                            <img src="Img/product 40.jpg"></img>
                            <img src="Img/product 40.jpg"></img>
                            <img src="Img/product 40.jpg"></img>
                        </div>
                        <img src="Img/product 40.jpg" className="product-img"></img>
                    </div>
            ...
            <div className="container description">
                ...
                <h4>Description</h4>
                <p>
                    CELLUCOR C4 Pre-Workout Original, 0.80 lbs, 360 g, 60 Servings <br></br>
                    Flavor Available - <br></br>
                    Watermelon <br></br>
                    Icy blue razz<br></br>
                    Cherry Lemonade
                </p>
