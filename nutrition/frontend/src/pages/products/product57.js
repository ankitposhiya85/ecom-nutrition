    ...
    return (
        <>
            <div className="product1">
                <h1>1UP NUTRITION WHEY PROTEIN 5 LBS</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        <div className="small-imgs">
                            <img src="Img/product 35.jpg"></img>
                            <img src="Img/product 35.jpg"></img>
                            <img src="Img/product 35.jpg"></img>
                            <img src="Img/product 35.jpg"></img>
                            <img src="Img/product 35.jpg"></img>
                        </div>
                        <img src="Img/product 35.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>1UP NUTRITION WHEY PROTEIN 5 LBS</h2>
            ...
            <div className="container description">
                ...
                <h4>Description</h4>
                <p>
                    1UP WHEY PROTEIN POWDER IS MORE THAN JUST A DELICIOUS HIGH QUALITY PROTEIN COMPLEX. EVERY FLOVOR IS AN AMAZING COMPLEMENTARY INGREDIENT FOR YOUR CREATIVE BAKING NEEDS. <br></br>
                    Flavor - Coconut Icecream
