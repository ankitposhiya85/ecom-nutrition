    ...
    return (
        <>
            <div className="product1">
                <h1>LABRADA 100% WHEY 4.4 LBS MOCHA CAPPUCCINO</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        <div className="small-imgs">
                            <img src="Img/product 11.jpg"></img>
                            <img src="Img/product 11.jpg"></img>
                            <img src="Img/product 11.jpg"></img>
                            <img src="Img/product 11.jpg"></img>
                            <img src="Img/product 11.jpg"></img>
                        </div>
                        <img src="Img/product 11.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>LABRADA 100% WHEY 4.4 LBS MOCHA CAPPUCCINO</h2>
            ...
            <div className="container description">
                ...
                <h4>Description</h4>
                <p>
                    Labrada 100% Whey 4.4 lbs Mocha Cappuccino <br></br>

                    This is a Vegetarian product. <br></br>
                    ...
                    Perfect for athletes, bodybuilders, and fitness enthusiasts <br></br>
                    0g Sugar, Gluten and Lactose free
                </p>
            </div>
        </>
    )
