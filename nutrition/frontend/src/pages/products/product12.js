    ...
    return (
        <>
            <div className="product1">
                <h1>FREAK SYDNEY SUNSET 30 SERVINGS</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        <div className="small-imgs">
                            <img src="Img/product 42.jpg"></img>
                            <img src="Img/product 42.jpg"></img>
                            <img src="Img/product 42.jpg"></img>
                            <img src="Img/product 42.jpg"></img>
                            <img src="Img/product 42.jpg"></img>
                        </div>
                        <img src="Img/product 42.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>FREAK SYDNEY SUNSET 30 SERVINGS</h2>
