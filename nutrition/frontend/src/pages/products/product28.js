    ...
    return (
        <>
            <div className="product1">
                <h1>BCAA ENERGY - 30 SERVING GREEN APPLE</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        <div className="small-imgs">
                            <img src="Img/product 31.jpg"></img>
                            <img src="Img/product 31.jpg"></img>
                            <img src="Img/product 31.jpg"></img>
                            <img src="Img/product 31.jpg"></img>
                            <img src="Img/product 31.jpg"></img>
                        </div>
                        <img src="Img/product 31.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>BCAA ENERGY - 30 SERVING GREEN APPLE</h2>
