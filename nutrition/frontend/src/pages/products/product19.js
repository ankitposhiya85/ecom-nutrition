    ...
    return (
        <>
            <div className="product1">
                <h1>LABRADA MARINE COLLAGEN PEPTIDES - 300 G</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        ...
                        <img src="Img/product 9.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>LABRADA MARINE COLLAGEN PEPTIDES - 300 G</h2>
            ...
            <div className="container description">
                ...
                <p>
                    ...
                    For healthy joints & skin <br></br>
                    Sourced from marine life to ensure high protein <br></br>
                    Non-GMO <br></br>
                    Easily soluble
                </p>
            </div>
