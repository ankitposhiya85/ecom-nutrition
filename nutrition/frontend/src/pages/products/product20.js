    ...
    return (
        <>
            ...
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        ...
                        <img src="Img/product 32.jpg" className="product-img"></img>
                    </div>
            ...
            <div className="container description">
                <h4>Category </h4><p>Wellness</p>
                <h4>Description</h4>
                <p>
                    ASHWAGANDHA - Powerful AntiOxidant-Indian Ginseng. Enhance Athletic Performance with Black Pepper for Maximum Absorption. Take 1 tablet once daily after any meal. <br></br>
                    Enhance Athletic Performance <br></br>
                    With Black Pepper for Maximum Absorption <br></br>

                    PRODUCT INFO <br></br>
                    In the prevention and treatment of many stress-related diseases like arteriosclerosis, premature aging, arthritis, diabetes, hypertension and malignancy, General debility, As a daily health supplement to cope with stress, As an aphrodisiac. <br></br>

                    DIRECTIONS TO USE <br></br>
                    As a dietary supplement, take 1 tablet once daily after any meal. <br></br>
