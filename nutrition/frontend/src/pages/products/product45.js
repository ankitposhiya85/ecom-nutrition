    ...
    return (
        <>
            <div className="product1">
                <h1>BIOX POWER WHEY COMPLEX 2KG  vanilla</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        <div className="small-imgs">
                            <img src="Img/product 19.jpg"></img>
                            <img src="Img/product 19.jpg"></img>
                            <img src="Img/product 19.jpg"></img>
                            <img src="Img/product 19.jpg"></img>
                            <img src="Img/product 19.jpg"></img>
                        </div>
                        <img src="Img/product 19.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>BIOX POWER WHEY COMPLEX 2KG  vanilla</h2>
            ...
            <div className="container description">
                ...
                <h4>Description</h4>
                <p>
                    25-27 grams of an easily dispersable, highly bioavailable Tri-Pro protein matrix. <br></br>
                    Fortified with Powerzyme, our digestive enzyme complex including the patented protein digesting enzyme: Aminogen. <br></br>
                    amazing flavours formulated using the latest and most advanced flavouring technology. <br></br>
                    high-quality protein source to your daily routine.
                </p>
            </div>
        </>
    )
