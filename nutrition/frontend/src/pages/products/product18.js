    ...
    return (
        <>
            <div className="product1">
                <h1>LABRADA GLUTALEAN (VEGAN, NON GMO, ALLERGEN FREE, MUSCLE RECOVERY, HEALTHY IMMUNE FUNCTION, 5G L-GLUTAMINE, 50 SERVINGS) - 0.55 LBS (250 G)</h1>
            </div>
            <div className="container product-detail">
                <div className="row">
                    <div className="col-md-6 col-12 d-flex">
                        ...
                        <img src="Img/product 6.jpg" className="product-img"></img>
                    </div>
                    <div className="col-md-6 col-12 product-txt">
                        <div className="product-detail1">
                            <div className="fav">
                                <h2>LABRADA GLUTALEAN (VEGAN, NON GMO, ALLERGEN FREE, MUSCLE RECOVERY, HEALTHY IMMUNE FUNCTION, 5G L-GLUTAMINE, 50 SERVINGS) - 0.55 LBS (250 G)</h2>
            ...
            <div className="container description">
                <h4>Category </h4><p>Muscle recover</p>
                <h4>Description</h4>
                <p>
                    Product Details <br></br>
                    Reduces muscle breakdown <br></br>
                    Stimulates muscle recovery post-workout <br></br>
                    Helps you gain and maintain a muscular physique
                </p>
            </div>
        </>
    )
